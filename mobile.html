...
<head>
	<meta charset="UTF-8" />
	<title>北京网站建设|网站制作|网站设计|高端网站建设 - 千助</title>
...
<body>
    ...
    <section class="video">
        ...
        <div class="innerBox">
        	<div class="news">
            	<span>NEWS :</span>
                <a href="http://www.mycodes.net" class="more" target="_blank">more</a>
                <ul>
    ...
    <section class="quality">
      <div class="box">
        ...
        <a href="http://www.mycodes.net" class="lookall" target="_blank">你以为看到了网站的全部？</a>
      </div>
    </section>
    	...
    	<div class="box">
        	<div class="above">
                ...
                <div class="left">
                    ...
                    <p>中国<u>·</u>北京<u></u>中关村科技园<br />联系电话：010-58859810<u>/</u>58859850<br />地址：海淀区上地东路盈创动力E座905<br />邮编：100085<a href="http://www.mycodes.net" target="_blank" class="job">[ 工作机会 ]</a></p>
                </div>
                <div class="right">
    ...
    <div class="dock">
        <ul class="icons">
        	<li class="up"><i></i></li>
            <li class="im">
            	<i></i><p>网站建设咨询<br />在线沟通，请点我<a href="http://www.mycodes.net" target="_blank">在线咨询</a></p>
            </li>
            <li class="tel">
